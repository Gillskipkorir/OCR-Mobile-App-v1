...
String upload_url="https://tal.co.ke/tal/newcli.php";
String fname="fname";
String lname="lname";
String email="email";
String phone="phone";
...
protected String doInBackground(String... params) {
    ...
    data1.put(phone,field4);
    data1.put(meterno,field5);
    try{
        ...
        try {
            ...
            if (code.equals("upload_true")) {
                ...
                new LovelyStandardDialog(ctx, LovelyStandardDialog.ButtonLayout.VERTICAL)
                        ...
                        .setTopTitle("Server Response")
                        .setTitle("FAILED!").setTitleGravity(Gravity.CENTER).setTopTitleColor(R.color.mdtp_white)
                        .setMessage("The meter Number your Inputed has already been Supplied").setMessageGravity(Gravity.CENTER)
                        .setCancelable(false)
                        .setPositiveButton("Try Again", new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
